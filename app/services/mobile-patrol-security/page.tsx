...
const faqs = serviceFaqs["mobile-patrol-security"]
...
export default function Page() {
  return (
    <>
      ...
      />
      <Client />
      <ServiceFAQSection faqs={faqs} serviceName="Mobile Patrol Security" currentPath="/services/mobile-patrol-security" />
    </>
  )
}
