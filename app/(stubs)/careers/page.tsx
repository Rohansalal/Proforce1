      ...
      <div className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-md">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="flex justify-center w-full">
            <button
              onClick={() => setActiveTab("application")}
              className={`flex-1 md:flex-none relative py-6 px-4 md:px-12 text-sm md:text-base font-bold transition-colors ${activeTab === "application" ? "text-red-700" : "text-slate-500 hover:text-slate-800"
                }`}
            >
            ...
            <button
              onClick={() => setActiveTab("careers")}
              className={`flex-1 md:flex-none relative py-6 px-4 md:px-12 text-sm md:text-base font-bold transition-colors ${activeTab === "careers" ? "text-red-700" : "text-slate-500 hover:text-slate-800"
                }`}
            >
              <span className="flex items-center justify-center gap-2">
