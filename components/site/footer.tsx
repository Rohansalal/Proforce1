...
//               <span className="text-4xl font-black tracking-tighter text-white group-hover:opacity-90 transition-opacity">
//                 PROFORCE<span className="text-red-600">1</span>
//               </span>
//             </Link>
//           </div>
            ...
            <Link href="/" className="group block">
              <span className="text-3xl font-black tracking-tighter text-white group-hover:opacity-90 transition-opacity whitespace-nowrap">
                ...
                <span className="relative inline-block">
                  O
                  <span className="absolute inset-y-0 left-1/2 w-[5px] -translate-x-1/2 bg-slate-950 block"></span>
                </span>
                FORCE<span className="text-red-600">1</span>
              </span>
            </Link>
          </div>
          ...
          <div className="space-y-6 lg:col-span-4">
            ...
            <div className="space-y-4 text-sm text-slate-300 leading-relaxed">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+18007797691" className="hover:text-white transition-colors font-medium text-base">(800) 779-7691</a>
              </div>
              <div className="flex items-center gap-3">
